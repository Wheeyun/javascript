const quotes = [
    ...
    {
        quote: '퍼센트의 가능성, 그것이 나의 길이다.',
        author: '나폴레옹',
    },
    {
        quote: '이 세상 모든 불이익은 본인의 능력부족.',
        author: '카네키 켄',
    },
];

const qouteSpan = document.querySelector(
...
//(0~quotes.length 랜덤숫자) -> 0~29까지 랜덤숫자

console.log(Math.random() * quotes.length); //0~29.xxxxxxxxx
...
qouteSpan.innerText = randomQuote.quote;
